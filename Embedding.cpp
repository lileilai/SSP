...
int main(int argc, char* argv[])
{
	...
	Dataset FB15k("FB15k", "./data/FB15k/", "train.txt", "valid.txt", "test.txt", true);
	
	model=new SemanticModel_Joint(FB15k,LinkPredictionHead,"./report/","./data/FB15k_description/FB15k_mid2description.txt",100,0.001,1.8,0.2,0.1);
	model->run(10000);
	model->test();
	delete model;
